...
import {fetchAddToCart} from '../../store/slices/cart/cartApi';
...
function ProductSingle({slug}) {
    ...
    const addToCart = useCallback(() => {
        ...
        dispatch(fetchAddToCart({
            ...
            userToken: loginData.access_token ? loginData.access_token : null,
...
// Apply each element to the Date function
    ...
    return (
        <>
                            ...
                            <div className="product-single__container _container">
                                ...
                                <div className="produc-single__flex">
                                    <div className="product-single__img">
                                        ...
                                        <Swiper className="produc-single__swiper"
                                                ...
                                                ref={swiperRef}>
                                            <SwiperSlide>
                                                <img src={`https://back.brend-instrument.ru${singlProductData.image}`}
                                                     alt="asd"/>
                                            </SwiperSlide>
                                            {
                                    ...
                                    <div className="produc-single__text">
                                        <div className="produc-single__text-buy">
                                            ...
                                            <div className="product-types">
                                                ...
                                                <p>Бренд:
                                                    <Link
                                                        href={`/brandSingle/${singlProductData.brand_id.label}`}> {singlProductData?.brand_id.name}</Link>
                                                </p>
                                            ...
                                            <div className="product-buttons">
                                                ...
                                                <button className='chek-btn' onClick={() => {
                                                    if (singlProductData.book.length < singlProductData.quantity) {
                                                        toggleModals("create")
                                                    }
                                                }}>
                                ...
                                <div className="produc-single__info">
                                    <div className="produc-single__info-buttons">
                                        <button className={toggleInfo ? "active" : "btn"}
                                                onClick={() => setToggleInfo(true)}>Характеристики
                                        </button>
                                        <button className={!toggleInfo ? "active" : "btn"}
                                                onClick={() => setToggleInfo(false)}>Описание
                                        </button>
                                    </div>
            ...
            {appModal === "create" ? <ApplicationModal {...{appModal, setAppModal}} /> : appModal === "succes" ?
                <SuccsesModal succsesClick={toggleModals} title={"Ваш запрос принят!"}/> : ""}
        </>
