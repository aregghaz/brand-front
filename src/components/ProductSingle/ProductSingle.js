        ...
        <>
            {isLoading ? (
                <>
                    ...
                    <Brendcrumbs title={singlProductData?.title} links={[...singlProductData.categories.map(el => ({ name: el.name, link: `/categorySingl/${el.label}` }))]} />
                        ...
                        <div className="product-single__container _container">
                            ...
                            <div className="produc-single__flex">
                                <div className="product-single__img">
                                    {singlProductData.special_price > 0 && <div className="discount_div">- {(100 - (singlProductData.special_price * 100) / singlProductData.price)} %</div>}
                                ...
                                <div className="produc-single__text">
                                    <div className="produc-single__text-buy">
                                        <div className="prices">
                                            ...
                                            {singlProductData?.special_price ? <span>{singlProductData.price} ₽</span> : <></>}
                                        </div>
                                        ...
                                        <div className="product-buttons">
                                            ...
                                            <button className='chek-btn' onClick={() => { if (singlProductData.book.length < singlProductData.quantity) { toggleModals("create") } }}>
                                                <CheckIcon />
                                                Запросить счет
                                            </button>
                                        </div>
                                    ...
                                    <div className="produc-single__text-delivery">
                                        <div className="delivery-info">
                                            <h4><Link href="/payment">Условия оплаты:</Link></h4>
                                            <ul>
                                        ...
                                        <div className="delivery-info">
                                            <h4><Link href={"/delivery"}>Доставка:</Link></h4>
                                            <ul>
